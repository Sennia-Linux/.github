...
A cozy fedora atomic remix based on [silverblue-nvidia](https://github.com/ublue-os/main/pkgs/container/silverblue-nvidia) by [ublue](https://universal-blue.org/).
